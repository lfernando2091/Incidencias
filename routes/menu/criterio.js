...
router.get('/', function(req, res, next){
	req.getConnection(function(err, connection) {
	      ...
	      connection.query(mappers.onQuery('criterio', 'catalogo', null), [], function(err, results) {
	        if (err) return next(err); 
...
router.post('/agregar', function(req, res, next){
	req.getConnection(function(err, connection) {
		...
		if(req.body.nombre_n == '' || req.body.clave_n == '')
	    {
	    	...
	    	return res.redirect('/criterio');	
	    }

	      connection.query(mappers.onQuery('criterio', 'agregar', param), [], function(err, results) {
	        if (err) return next(err); 
...
router.post('/editar', function(req, res, next){
	req.getConnection(function(err, connection) {
	      ...
	      connection.query(mappers.onQuery('criterio', 'actualizar', param), [], function(err, results) {
	        if (err) return next(err); 
...
router.post('/eliminar', function(req, res, next){
	req.getConnection(function(err, connection) {
	      ...
	      connection.query(mappers.onQuery('criterio', 'eliminar', param), [], function(err, results) {
	        if (err) return next(err); 
